...
tokenizer_emb = AutoTokenizer.from_pretrained(r"/deepseek/BAAIbge_small_zh")
model_emb = AutoModel.from_pretrained(r"/deepseek/BAAIbge_small_zh")
embeddings = HuggingFaceEmbeddings(
    model_name=r"E:\llm\deepseek\BAAIbge-small-zh",
...
vectorstore = Chroma.from_documents(
    documents=split,
    embedding_function=custom_embed,  # 使用自定义嵌入函数
